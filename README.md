...
**Research Interests**: My current research interests are **interactive and data-centric AI/ML** with an emphasis on **faithful evaluation** and **effort-light approaches** with applications in chemistry, biology, physics, etc. My past explorations lay at the intersection of machine learning, data mining, and natural language processing. I have contributed to many exciting projects including [AutoGen](https://arxiv.org/abs/2308.08155), [DataComp](https://arxiv.org/abs/2304.14108), and [BLIP3](https://arxiv.org/abs/2408.08872).
